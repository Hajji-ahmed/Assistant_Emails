...
SMTP_PORT = 465
EMAILS_JSON_FILE = "generated_emails.json"
    ...
    for idx, email_data in enumerate(emails_to_send, 1):
        ...
        try:
            msg = create_email_message(
                recipient_name=email_data['hr_name'],
        ...
        for attempt in range(1, max_retries + 1):
            ...
            if send_single_email(msg, email_data['hr_email'], company_name):
                successful_sends += 1
                break
